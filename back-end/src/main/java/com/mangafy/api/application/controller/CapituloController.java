...
public class CapituloController {
	...
	@PostMapping
	public ResponseEntity<Capitulo> create(@RequestBody @Valid CapituloDto dto) {
		try {
			return ResponseEntity.status(HttpStatus.CREATED).body(this.capituloService.create(dto));
		} catch (Exception e) {
